...
<body>
    ...
    <header>
        <div class="container-lg d-flex justify-content-between align-items-center">
                ...
                <div class="collapse navbar-collapse custom-menu" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item d-none d-lg-block">
                            <a class="nav-link" href="<?php echo e(route('petitions.all')); ?>">Peticiones</a>
                        </li>
                        <li class="nav-item d-none d-lg-block">
            ...
            <div class="d-flex align-items-center">
                    <a href="<?php echo e(route('petitions.create')); ?>" class="btn btn-outline-secondary peticion me-2">
                    Inicia una petición
                </a>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(Auth::user()->role === 1): ?>
                        <a href="<?php echo e(route('admin.home')); ?>" class="btn btn-danger me-2">
                            Panel Admin
                        </a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-link p-0 d-none d-lg-block ml-2">
...
<?php /**PATH C:\Users\Alumno\Desktop\monolitico-master\resources\views/layouts/public.blade.php ENDPATH**/ ?>